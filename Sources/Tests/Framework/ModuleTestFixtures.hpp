...
namespace rune::test
{
        ...
        Array<String> const& searchPaths = {})
    {
        ...
        context.getModuleDecl().searchPaths = searchPaths;
    ...
    inline Module loadBuiltModule(
        std::filesystem::path const& artifactPath,
        Array<String> const& searchPaths = {})
    {
        ModuleDecl moduleDecl;
        moduleDecl.name = "Client";
        moduleDecl.searchPaths = searchPaths;
        ASTContext loadContext(std::move(moduleDecl));
