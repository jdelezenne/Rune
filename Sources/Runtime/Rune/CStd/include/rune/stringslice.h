...
/// Returns whether two string slices contain identical bytes.
/// @param left Left-hand string slice.
/// @param right Right-hand string slice.
/// @return True when both slices are byte-equal.
bool rune_stringslice_equal(RuneStringSlice const* left, RuneStringSlice const* right);
