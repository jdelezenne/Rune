...
/// Returns whether two owned C strings have identical contents.
/// @param left Left-hand C string.
/// @param right Right-hand C string.
/// @return True when both strings are equal.
bool rune_cstring_storage_equal(RuneCString const* left, RuneCString const* right);
...
/// Returns whether two borrowed C string slices have identical contents.
/// @param left Left-hand C string slice.
/// @param right Right-hand C string slice.
/// @return True when both strings are equal.
bool rune_cstring_slice_equal(RuneCStringSlice const* left, RuneCStringSlice const* right);
