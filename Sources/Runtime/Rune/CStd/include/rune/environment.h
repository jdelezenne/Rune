...
RuneString rune_environment_get_temporary_directory(void);

/// Returns the executable path.
/// @return Executable path.
RuneString rune_environment_get_executable_path(void);

/// Overrides the directory containing resources for the running application.
/// Hosts such as the VM use this to point at the selected artifact directory.
void rune_environment_set_resources_directory(char const* path);

/// Returns the application Resources directory.
/// By default this is the Resources directory beside the executable.
RuneString rune_environment_get_resources_directory(void);
...
/// @return Process ID as a pointer-sized integer (matches Rune `Int`).
intptr rune_environment_get_process_id(void);
...
/// @return Processor count as a pointer-sized integer (matches Rune `Int`).
intptr rune_environment_get_processor_count(void);
