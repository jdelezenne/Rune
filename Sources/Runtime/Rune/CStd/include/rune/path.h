...
/// Returns true when both paths contain the same normalized bytes.
/// @param lhs Left path to compare.
/// @param rhs Right path to compare.
/// @return `true` when equal.
bool rune_path_equal(RunePath const* lhs, RunePath const* rhs);
...
bool rune_path_parent(RunePath const* self, RunePath* out);
