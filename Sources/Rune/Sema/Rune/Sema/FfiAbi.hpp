...
namespace rune::sema
{
    /// True only when a type has a direct, allocation-free C ABI representation.
    /// This is the contract used by @symbol declarations and C callback aliases.
    bool isCAbiRepresentableType(
    ...
    bool isFfiHandleInputSlotParameterType(
        ASTContext const& context,
        TypeID paramTypeId,
        Optional<TypeID>* outOptionTypeId = nullptr);
