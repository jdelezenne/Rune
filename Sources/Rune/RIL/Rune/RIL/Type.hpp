...
namespace rune::ril
{
    ...
    Result<Type> serializedBodyRILTypeFromSemanticType(ASTContext const& context, TypeID typeId, SourceLocation location);
    Result<Type> serializedBodyRILTypeFromSemanticType(
        ASTContext const& context,
        TypeID typeId,
        Array<IdentifierID> const& genericParameterNameIds,
        SourceLocation location);
    Type methodReceiverParameterType(Type receiverType, bool isMutating);
