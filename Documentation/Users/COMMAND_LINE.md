...
| `--platform <name>` | Target platform: `darwin`, `linux`, or `windows` (default: host) |
...
| `Error: --executable, --library, --name, --format, and --dependency are only valid for source builds` | Source-only flags were used with a manifest build. |
...
rune run Binaries/Darwin/Debug/Rune/modules/App.runemodule
...
rune Binaries/Darwin/Debug/Rune/modules/App.runemodule
```
...
```bash
rune inspect module Binaries/Darwin/Debug/Rune/modules/Rune.runemodule
...
```bash
rune inspect bytecode Binaries/Darwin/Debug/Rune/modules/vm/Rune.runebc
...
```bash
rune dev bytecode Binaries/Darwin/Debug/Rune/modules/vm/Rune.runebc
...
```bash
rune lsp --stdio
rune lsp --stdio -I Binaries/Darwin/Debug/Rune/modules
```
...
rune debug App.runemanifest --backend vm -I Binaries/Darwin/Debug/Rune/modules
```
