...
Rune is a statically typed programming language for systems and application development, implemented in C++23. It is cross-platform on Windows, macOS, and Linux, and supports three backends: LLVM (native executable), C23 (generated code), and VM (custom Bytecode and Virtual Machine).
